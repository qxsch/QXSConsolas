...
@CliApp(
    ...
    Opts = [ 
        { "argument": "--name:",     "default": None, "multiple": True, "description": "the names",          "valuename": "NAME" },
        { "argument": "--verbose::", "default": 0,                      "description": "be verbose",         "valuename": "VERBOSITY" },
        { "argument": "-v::",        "default": 0,                      "references": "--verbose::",         "valuename": "VERBOSITY" },
        { "argument": "--key=",      "default": None,                   "description": "important value",    "valuename": "VALUE"}
    ]
)
def Test(app):
